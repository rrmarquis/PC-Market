...
public class BuyGPU {
  ...
  public void testBuyGPU() throws Exception {
    ...
    driver.get("http://ec2-3-82-116-24.compute-1.amazonaws.com:8080/PCMarket/CurrentListings.jsp");
    driver.findElement(By.linkText("Login")).click();
    driver.findElement(By.linkText("Create Account")).click();
    driver.findElement(By.name("name")).click();
    driver.findElement(By.name("name")).clear();
    driver.findElement(By.name("name")).sendKeys("pcmarketuser");
    driver.findElement(By.name("name")).click();
    driver.findElement(By.name("name")).clear();
    driver.findElement(By.name("name")).sendKeys("pcmarketuser1");
    ...
    driver.findElement(By.xpath("(//input[@name='modelName'])[2]")).click();
    driver.findElement(By.xpath("(//input[@name='modelName'])[2]")).clear();
    driver.findElement(By.xpath("(//input[@name='modelName'])[2]")).sendKeys("1");
    driver.findElement(By.name("clockSpeed")).clear();
    driver.findElement(By.name("clockSpeed")).sendKeys("1");
    driver.findElement(By.name("interf")).clear();
    driver.findElement(By.name("interf")).sendKeys("1");
    driver.findElement(By.name("memory")).clear();
    driver.findElement(By.name("memory")).sendKeys("1");
    driver.findElement(By.xpath("(//input[@value='sell'])[2]")).click();
