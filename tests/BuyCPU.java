...
public class BuyCPU {
  ...
  @Test
  public void testBuyCPU() throws Exception {
    ...
    driver.findElement(By.name("cores")).sendKeys("1");
    driver.findElement(By.name("frequency")).sendKeys("1");
    driver.findElement(By.name("socket")).sendKeys("1");
    ...
    driver.findElement(By.name("socket")).sendKeys("1");
    driver.findElement(By.xpath("//input[@value='sell']")).click();
    driver.findElement(By.xpath("//div[@id='chart']/div/canvas[2]")).click();
    driver.findElement(By.name("price")).sendKeys("100");
    driver.findElement(By.xpath("//form[@action='SellConfirmation.jsp']")).click();
    driver.findElement(By.xpath("//input[@value='Sell']")).click();
    driver.findElement(By.xpath("//button")).click();
    driver.findElement(By.xpath("//div[4]/a/button")).click();
    driver.findElement(By.name("email")).sendKeys("pcmarketuser2@gmail.com");
