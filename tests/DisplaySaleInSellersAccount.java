...
public class DisplaySaleInSellersAccount {
  ...
  @Test
  public void testDisplaySaleInSellersAccount() throws Exception {
    ...
    driver.findElement(By.name("modelName")).sendKeys("1");
    driver.findElement(By.xpath("(//input[@name='modelName'])[5]")).click();
    driver.findElement(By.xpath("(//input[@name='modelName'])[5]")).clear();
    driver.findElement(By.xpath("(//input[@name='modelName'])[5]")).sendKeys("1");
    driver.findElement(By.name("type")).sendKeys("1");
    driver.findElement(By.name("capacity")).sendKeys("1");
    driver.findElement(By.xpath("//form[5]/div[4]")).click();
    driver.findElement(By.name("speed")).sendKeys("1");
    driver.findElement(By.xpath("//form[5]/div[5]")).click();
