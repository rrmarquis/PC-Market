...
public class CreateHardDriveFollowing {
  ...
  @Test
  public void testCreateHardDriveFollowing() throws Exception {
    ...
    driver.findElement(By.name("storage")).sendKeys("2 TB");
    driver.findElement(By.name("rpm")).click();
    driver.findElement(By.name("rpm")).clear();
    driver.findElement(By.name("rpm")).sendKeys("7200");
    driver.findElement(By.xpath("(//input[@name='price'])[3]")).click();
    driver.findElement(By.xpath("(//input[@name='price'])[3]")).clear();
    driver.findElement(By.xpath("(//input[@name='price'])[3]")).sendKeys("321");
    driver.findElement(By.xpath("(//input[@value='Create'])[3]")).click();
