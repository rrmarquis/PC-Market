...
public class CreateRAMFollowing {
  ...
  @Test
  public void testCreateRAMFollowing() throws Exception {
    ...
    driver.findElement(By.name("speed")).clear();
    driver.findElement(By.name("speed")).sendKeys("3200");
    driver.findElement(By.xpath("(//input[@name='price'])[5]")).clear();
    driver.findElement(By.xpath("(//input[@name='price'])[5]")).sendKeys("320");
