...
public class DisplayPurchaseInBuyersAccount {
  ...
  @Test
  public void testDisplayPurchaseInBuyersAccount() throws Exception {
    ...
    driver.findElement(By.xpath("//button")).click();
    driver.findElement(By.xpath("(//input[@name='modelName'])[5]")).sendKeys("2");
    driver.findElement(By.name("type")).sendKeys("2");
    driver.findElement(By.name("capacity")).sendKeys("2");
    driver.findElement(By.name("speed")).sendKeys("2");
