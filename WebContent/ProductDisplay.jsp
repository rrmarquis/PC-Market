      ...
      <div style="width:600px; height:250px; overflow:auto; margin-left: auto; margin-right: auto;">
      	<table border ="1" width="500" align="center">
			...
			<tr>
				...
				<td><%=c.getPrice()%></td>
				<td><a href="BuyPage.jsp?id=<%=c.getModelName()%>&type=CPU">Buy</a>
			</tr> 
			<%}%>
		</table>
		</div>
        ...
        <table border ="1" width="500" align="center">
			...
			<tr>
				...
				<td><%=g.getPrice()%></td>
				<td><a href="BuyPage.jsp?id=<%=g.getModelName()%>&type=GPU">Buy</a>
			</tr> 
			<%}%> 
		</table>
		...
		<table border ="1" width="500" align="center"> 
			...
			<tr>
				...
				<td><%=h.getPrice()%></td>
				<td><a href="BuyPage.jsp?id=<%=h.getModelName()%>&type=Hard Drive">Buy</a>
			</tr> 
			<%}%>
		</table>
        ...
        <table border ="1" width="500" align="center"> 
			...
			<tr> 
				...
				<td><%=m.getPrice()%></td>
				<td><a href="BuyPage.jsp?id=<%=m.getModelName()%>&type=Motherboard">Buy</a>
			</tr> 
			<%}%>
		</table>
        <hr/> 
