...
<body style="width: 100%; display: flex; flex-direction: column; align-items: center;">
	...
	<div style="width: 800px; padding-left: 20px;">
		<form action="SingleListing.jsp" style="padding-top: 5px; display: flex; flex-direction: column; width: 300px;">
			<h1>CPU</h1>
			...
			<div style="padding-top: 2px; padding-bottom: 2px;"><input type="submit" value="Find"></div>
			<input type="hidden" name="partType" value="CPU">
		</form>
		<form action="SingleListing.jsp" style="padding-top: 5px; padding-bottom: 5px; display: flex; flex-direction: column; width: 300px;">
			<h1>GPU</h1>
